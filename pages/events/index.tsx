...
export default function Events() {
  ...
  useEffect(() => {
    if (getCommunityBranding()?.apsosReferenceId) {
      loadData();
    }
  ...
  async function loadData() {
    ...
    // let currentEvents = allEvents.filter((e) => e?.daoId == getCommunityBranding().apsosReferenceId);
    // setDaoID(Number(getCommunityBranding().apsosReferenceId));
    // try {
    //   let eventArr = [];
