...
export default function AddData() {
  ...
  async function AddCharities() {
    ...
    //       await CommunityService.create({ template: '', apsosReferenceId: newDao.daoId.toString(), name: newDao.Title, imageUrl: newDao.logo, brandingColor: newDao.brandingColor, subdomain: newDao.customUrl, description: '' });
