...
export default function GrantIdeas() {
  ...
  const [IdeasURI, setIdeasURI] = useState({ ideasId: '', Title: '', Description: '', Referenda: 0, wallet: '', recieve_wallet: '', logo: '', End_Date: '', voted: 0, delegAmount: 0, delegDated: '', recievetype: '', isVoted: true, isOwner: true, allfiles: [], votesAmount: 0, goalURI: {} as Goal, user_info: {} } as Idea);
